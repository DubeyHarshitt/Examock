...
router.post('/exam-type',   requireAuth, validate(schemas.examType),         selectExamType)

// Onboarding — send OTP
router.post('/otp/send',    requireAuth, otpSendLimiter,  validate(schemas.sendOtp),    sendOtp)

// Onboarding — verify OTP
router.post('/otp/verify',  requireAuth, otpVerifyLimiter, validate(schemas.verifyOtp), verifyOtp)
